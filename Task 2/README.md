...
### Confusion Matrices
![alt text](<sc  aug 9081.png>) ![alt text](<sc no aug 9141.png>) ![alt text](<tr  aug 8180.png>) ![alt text](<tr no aug 8654.png>)
### Loss & Accuracy Curves
![alt text](<tvgg aug la.png>) ![alt text](<tvgg noaug la.png>) ![alt text](<res18 aug la.png>) ![alt text](<res18 noaug la.png>)
## Analysis
